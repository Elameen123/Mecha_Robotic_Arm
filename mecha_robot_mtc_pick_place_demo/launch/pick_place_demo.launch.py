...
def generate_launch_description():
    ...
    package_name_moveit_config = 'mecha_robot_moveit_config'
    package_name_mtc_pick_place_demo = 'mecha_robot_mtc_pick_place_demo'
    ...
    def configure_setup(context):
        ...
        mtc_demo_node = Node(
            package="mecha_robot_mtc_pick_place_demo",
            executable=exe,
            output="screen",
            parameters=[

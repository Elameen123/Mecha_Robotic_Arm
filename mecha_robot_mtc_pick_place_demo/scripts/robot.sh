...
ros2 launch mecha_robot_gazebo mycobot.gazebo.launch.py \
...
ros2 launch mecha_robot_moveit_config move_group.launch.py \
...
ros2 launch mecha_robot_mtc_pick_place_demo get_planning_scene_server.launch.py &
sleep 5
ros2 launch mecha_robot_mtc_pick_place_demo pick_place_demo.launch.py

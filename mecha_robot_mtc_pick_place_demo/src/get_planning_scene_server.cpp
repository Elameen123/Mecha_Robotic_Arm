...
#include "mecha_robot_mtc_pick_place_demo/cluster_extraction.h"
#include "mecha_robot_mtc_pick_place_demo/normals_curvature_and_rsd_estimation.h"
#include "mecha_robot_mtc_pick_place_demo/object_segmentation.h"
#include "mecha_robot_mtc_pick_place_demo/plane_segmentation.h"
#include <mecha_robot_interfaces/srv/get_planning_scene.hpp>
...
class GetPlanningSceneServer : public rclcpp::Node {
 ...
 private:
  ...
  // Service
  rclcpp::Service<mecha_robot_interfaces::srv::GetPlanningScene>::SharedPtr service;
  ...
  void createService() {
    ...
    service = this->create_service<mecha_robot_interfaces::srv::GetPlanningScene>(
   ...
   **********************************************************************************/
  void handleService(
      const std::shared_ptr<mecha_robot_interfaces::srv::GetPlanningScene::Request> request,
      std::shared_ptr<mecha_robot_interfaces::srv::GetPlanningScene::Response> response) {
